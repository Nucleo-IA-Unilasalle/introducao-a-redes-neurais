...
> **Nota:** Ele deve ser capaz de comportar o mesmo número de valores do array original. Além disso, se você souber de quantas linhas precisa, mas não quantas colunas (ou vice-versa), você pode passar `-1` como argumento para a função.
